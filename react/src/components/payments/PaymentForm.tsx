...
const PaymentForm = ({
  ...
  return (
    ...
    >
      ...
      {/* Form Column */}
      <div className={`${isMobile ? "w-full" : "w-2/3"} space-y-6`}>
        <form onSubmit={handleSubmit}>
          {/* Frequency Section */}
          <div className="space-y-3">
            <h3 className="text-xl font-medium">Frequency</h3>
          ...
          <div className="space-y-3 mt-6">
            <h3 className="text-xl font-medium">Donation amount</h3>
          ...
          <div className="space-y-4 mt-6 bg-white p-5 rounded-md border border-gray-100 shadow-sm">
          ...
          paymentMethod === "venmo" ? (
            <Button
              type="button"
              className="w-full mt-6 py-3 h-auto text-lg shadow-md"
