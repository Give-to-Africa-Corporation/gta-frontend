            ...
            <div className="max-w-3xl mx-auto divide-y">
              <div className="py-5">
                ...
                <p className="text-gray-600">
                  ...
                  verification process by submitting required documents such as
                  your NGO registration certificate, proof of leadership, and
                  impact summary.
                </p>
              </div>
              <div className="py-5">
                ...
                <p className="text-gray-600">
                  ...
                  For more complex cases, it may take up to 5 business days.
                </p>
              </div>
              <div className="py-5">
                <h3 className="text-xl font-semibold mb-2">
              ...
              <div className="py-5">
                ...
                <p className="text-gray-600">
                  Donations are transferred to your registered bank account on a
                  monthly basis, or when they reach a minimum threshold of $100.
                </p>
              </div>
            </div>
          </div>
