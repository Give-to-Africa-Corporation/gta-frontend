          ...
          <div className="w-full">
            {!showInput ? (
              <button
                ...
                className="px-4 py-2 mt-3 bg-transparent text-primary border border-dotted border-2 hover:bg-primary hover:text-white border-primary rounded-lg"
              >
                Set Target Amount
              </button>
            ) : (
