  ...
  return (
    ...
    >
      <div className="flex min-h-screen w-full">
        ...
        <SidebarInset className="bg-[#848a4511]">
          {/* ===== TOP SECTION ===== */}
          <div className="relative rounded-b-2xl px-10  pt-10 overflow-hidden">
            <h1 className="text-2xl font-semibold text-[#2E3333] mb-6">
              Causes
            </h1>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="flex items-center relative h-[280px]">
                <h2 className="text-4xl font-bold text-primary leading-tight">
                  You’re ready to collect <br /> your first donations!
                </h2>
                <div className="MuiBox-root css-qy1iac">
                  <svg
                    viewBox="0 0 166 226"
                    fill="none"
          ...
          {/* ===== SEARCH & BUTTON ===== */}
          <div className="p-4 shadow-md bg-white mx-4 my-2 rounded-xl">
            ...
            <div className="space-y-4">
              ...
              {filteredCampaigns?.length == 0 && (
                <div className="flex justify-center items-center py-12 flex-col">
                  ...
                  <p>You have no campaigns at this time.</p>
                </div>
              )}
            </div>
          </div>
