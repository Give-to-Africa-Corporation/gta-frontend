...
import bgFlag7 from "../../../public/images/flag7.png";
      ...
      <main className="flex-grow">
        ...
        >
          ...
          <div className="relative">
            {/* CATEGORY TILES */}
            <section className="max-w-4xl mx-auto pt-12 px-4">
            ...
            {/* PROMOTED ARTICLES */}
            <section className="max-w-4xl text-white mx-auto mt-16 px-4">
            ...
            {/* FAQ ACCORDION */}
            <section className="max-w-4xl mx-auto mt-16 px-4 pb-24">
              <h2 className="text-3xl text-white font-bold mb-6">FAQ Section</h2>
