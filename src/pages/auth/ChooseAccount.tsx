  ...
  return (
    ...
    <div className="flex-grow flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="relative flex items-center justify-center">
        <Card className="bg-white rounded-3xl shadow-lg max-w-xl w-full p-4 sm:p-8 z-50">
          ...
          <div className="flex gap-3 flex-col mt-8">
            <Link to="/signup-donor">
              <button className="group flex items-center justify-between w-full border-2 border-brand-purple rounded-3xl p-3 transition-all duration-300 ease-in-out">
