  ...
  return (
    <>
      <div className="w-full bg-background text-foreground">
        ...
        {/* TRANSACTION FEES */}
        <section className="max-w-6xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-10 items-center">
        ...
        <section className="bg-muted/30 py-12">
          <Card className="max-w-3xl mx-auto shadow-md border-none">
            <CardHeader>
              ...
              <CardDescription className="mt-3">
                Thanks to our philanthropic partners and donor tips, nonprofits
                never pay a platform fee to use Yendaa.
              </CardDescription>
            </CardHeader>
        ...
        <section className="bg-muted/30 py-12">
          <Card className="max-w-xl mx-auto">
            <CardHeader>
              <CardTitle>Optional Donor Tips: How We Sustain Yendaa</CardTitle>
              <CardDescription className="mt-3">
