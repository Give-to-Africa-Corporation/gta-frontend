...
export const TestimonialsSection = () => {
  const testimonials = [
    {
      quote:
        "FundraiserConnect made it easy for us to get verified and start fundraising for our clean water projects. The platform's credibility helped us gain donor trust.",
      name: "Sarah Johnson",
    ...
    <section className="py-20 bg-gray-50">
      <div className="container-custom">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-16">
          See how verified organizations are making an impact with
          FundraiserConnect
        </p>
