  ...
  const ctaItems = [
    {
      ...
      description:
        "Get verified, receive online donations, and become a recognized Grassroots Champion on Campaign to Raising Africa. Register now to connect with global donors who believe in local, community-led impact.",
    ...
    },
    {
      ...
      description:
        "Set up a family foundation or donor-advised fund (DAF) through Campaign to Raising Africa and support causes close to your heart. Whether you're giving as a family or individual, we make it easy to create impact across Africa. Start your journey in meaningful giving today.",
