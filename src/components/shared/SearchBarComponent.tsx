...
const SearchBarComponent = ({ query, setQuery, isOpen, setIsOpen }) => {
    return (
        <>
            <div className="flex items-center bg-white rounded-xl shadow-lg border border-gray-200 px-4 py-4">
                ...
                <div className="absolute top-14 left-0 w-full bg-white rounded-xl shadow-xl border border-gray-200 z-50">
                    <div className="p-5">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-5">
                            {["Gatter Foundation", "Gathering Roots", "Soak Gathering", "Go Gather"].map(
                                (name, i) => (
                                    <div
                                        key={i}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {["Courtney Gatter", "David Gatter", "Chris Gathercole", "Egide Gatera"].map(
                                (name, i) => (
                                    <div
                                        key={i}
                                        className="flex items-center gap-2 text-gray-700 hover:bg-gray-50 p-2 rounded-lg cursor-pointer"
