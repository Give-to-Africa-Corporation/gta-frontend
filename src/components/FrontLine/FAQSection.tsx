...
const faqItems = [
  {
    ...
    answer:
      "Yes. Campaign to Raising Africa is a registered 501(c)(3) nonprofit organization. Your donation is tax-deductible to the extent allowed by law. You will receive an email receipt for your records.",
  },
  {
    id: "item-2",
