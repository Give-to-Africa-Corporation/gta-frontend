...
const Hero = () => {
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden bg-[#034623] pt-8 md:pt-16 lg:pb-20">
      {/* Split Layout Container */}
      <div className="container-custom  mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        {/* Hero Image */}
        ...
        {/* Hero Content */}
        <div className="w-full lg:w-1/2 text-white px-0 md:px-4 lg:px-8">
          <h1 className="text-4xl lg:text-7xl font-bold mb-6 leading-tight">
            The Frontline Fund
          </h1>

          <p className="text-lg lg:text-3xl font-medium mb-4 leading-relaxed">
