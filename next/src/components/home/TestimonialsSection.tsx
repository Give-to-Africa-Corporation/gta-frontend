...
export const TestimonialsSection = () => {
  const testimonials = [
    {
      quote:
        "Give to Africa made it easy for us to get verified and start fundraising for our clean water projects. The platform's credibility helped us gain donor trust.",
      name: "Sarah Johnson",
